...
export const translations = {
  en: {
    ...
    freeDeliveryNote: "Colombo area only · outside Colombo LKR 350",
    freeDeliveryUnlocked: "Colombo area delivery is free",
    addMore: "Outside Colombo delivery is LKR 350",
    ...
    deliveryProgressUnlocked: "Colombo area delivery is free",
    deliveryProgressAdd: "Outside Colombo delivery is LKR {0}",
    deliveryProgressFree: "",
    /* ---- Announcement Bar ---- */
    announcement: "🎁 Limited time: 5% off + Colombo delivery free · Outside Colombo LKR 350",
    /* ---- Live Purchase Notification ---- */
    justOrdered: "just ordered",
    minutesAgo: "min ago",
    /* ---- Newsletter ---- */
    newsletterBadge: "Get 5% Off Your First Order",
    newsletterTitle: "Join the Hygenc Family",
    newsletterSub: "Hygiene tips, new product drops, and exclusive subscriber-only discounts — straight to your inbox.",
    ...
    newsletterThanksSub: "We'll send your discount code shortly.",
    /* ---- Trust Badges ---- */
    trustSecure: "Secure Checkout",
    trustSecureDesc: "WhatsApp-encrypted ordering",
    trustDelivery: "Island-wide Delivery",
    trustDeliveryDesc: "Fast, tracked & reliable",
    trustGuarantee: "Money-back Guarantee",
    trustGuaranteeDesc: "Not happy? Full refund",
    trustReviews: "4.9 / 5 Customer Rating",
    trustReviewsDesc: "Based on 124+ reviews",
    /* ---- Cart ---- */
    yourCart: "Your Cart",
    cartEmpty: "Your cart is empty",
    cartEmptySub: "Add a product to get started",
    cartSubtotal: "Subtotal",
    cartCheckout: "Checkout via WhatsApp",
    cartClear: "Clear cart",
    cartRemove: "Remove",
    cartAddMore: "Add",
    cartForFreeDelivery: "outside Colombo delivery",
    cartFreeUnlocked: "Colombo delivery is free!",
    addToCart: "Add to Cart",
    addedToCart: "✓ Added",
    /* ---- Before/After ---- */
    before: "BEFORE",
    after: "AFTER",
    beforeNote: "295 bacteria types · 48hr survival",
    afterNote: "99% protection · biodegradable",
    /* ---- Hero polish ---- */
    heroBadge: "Sri Lanka's #1 Hygiene Brand",
    heroStat1: "10,000+",
    heroStat1Label: "Packs sold",
    heroStat2: "4.9★",
    heroStat2Label: "Customer rating",
    heroStat3: "99%",
    heroStat3Label: "Protection",
    /* ---- Why us section ---- */
    whyUsBadge: "Why customers choose us",
    /* ---- FAQ teaser ---- */
    faqTeaserTitle: "Quick Answers",
    faqTeaserSub: "The questions our customers ask most",
    faqQ1: "Are these covers really biodegradable?",
    faqA1: "Yes — our covers are made from plant-based, compostable fibres that break down naturally within weeks. Safe for septic systems too.",
    faqQ2: "How long does delivery take?",
    faqA2: "Colombo area: 1–2 business days with free delivery. Outside Colombo: 2–5 business days with LKR 350 delivery.",
    faqQ3: "Can I return them if I'm not satisfied?",
    faqA3: "Absolutely. We offer a 100% money-back guarantee within 7 days of delivery — no questions asked.",
    faqQ4: "Do you offer bulk discounts for hotels or offices?",
    faqA4: "Yes. We have special enterprise pricing for hotels, hospitals, offices, and government buildings. Contact us via the B2B page for a custom quote.",
    faqQ5: "Are the covers safe for sensitive skin?",
    faqA5: "Yes — they're hypoallergenic, dermatologist-tested, and free from harsh chemicals. Safe for children, seniors, and pregnant women.",
    /* ---- Video / how-it-works section ---- */
    seeItInAction: "See It In Action",
    dragSliderTip: "Drag the slider to see the difference",
    /* ---- Press / featured-in ---- */
  ...
  si: {
    ...
    freeDeliveryNote: "කොළඹ ප්‍රදේශයට පමණි · කොළඹින් පිටත LKR 350",
    freeDeliveryUnlocked: "කොළඹ ප්‍රදේශයට delivery නොමිලේ",
    addMore: "කොළඹින් පිටත delivery LKR 350",
    ...
    deliveryProgressUnlocked: "කොළඹ ප්‍රදේශයට delivery නොමිලේ",
    deliveryProgressAdd: "කොළඹින් පිටත delivery LKR {0}",
    deliveryProgressFree: "",
    /* ---- Announcement Bar ---- */
    announcement: "🎁 සීමිත කාලය: 5% වට්ටමක් + කොළඹ delivery නොමිලේ · කොළඹින් පිටත LKR 350",
    /* ---- Live Purchase ---- */
    justOrdered: "අලුතෙන් ඇණවුම් කළා",
    minutesAgo: "මිනිත්තු කලින්",
    /* ---- Newsletter ---- */
    newsletterBadge: "ඔබේ පළමු ඇණවුමෙන් 5% ක් ලබාගන්න",
    newsletterTitle: "Hygenc පවුලට එක්වන්න",
    newsletterSub: "සනීපාරක්ෂා උපදෙස්, නව නිෂ්පාදන සහ විශේෂ වට්ටම් — සෘජුවම ඔබේ inbox එකට.",
    newsletterPlaceholder: "ඔබේ email ලිපිනය",
    newsletterCta: "මගේ වට්ටම ලබාගන්න →",
    newsletterPrivacy: "Spam නැත. ඕනෑම වෙලාවක unsubscribe කළ හැක.",
    newsletterThanks: "ඔබ එකතු වුණා! ඔබේ inbox පරීක්ෂා කරන්න.",
    newsletterThanksSub: "අපි ඉක්මනින් ඔබේ වට්ටම් code එක එවනවා.",
    /* ---- Trust Badges ---- */
    trustSecure: "ආරක්ෂිත Checkout",
    trustSecureDesc: "WhatsApp encrypted ඇණවුම්",
    trustDelivery: "දිවයින පුරා Delivery",
    trustDeliveryDesc: "ශීඝ්‍ර, විශ්වාසනීය",
    trustGuarantee: "මුදල් ආපසු සහතිකය",
    trustGuaranteeDesc: "තෘප්තිමත් නැද්ද? සම්පූර්ණ ආපසු",
    trustReviews: "4.9 / 5 ගනුදෙනුකරු ශ්‍රේණිගත කිරීම",
    trustReviewsDesc: "124+ සමාලෝචන මත පදනම්",
    /* ---- Cart ---- */
    yourCart: "ඔබේ Cart එක",
    cartEmpty: "ඔබේ cart එක හිස්",
    cartEmptySub: "ආරම්භ කිරීමට නිෂ්පාදනයක් එකතු කරන්න",
    cartSubtotal: "Subtotal",
    cartCheckout: "WhatsApp හරහා Checkout",
    cartClear: "Cart හිස් කරන්න",
    cartRemove: "ඉවත් කරන්න",
    cartAddMore: "තවත් එකතු කරන්න",
    cartForFreeDelivery: "කොළඹින් පිටත delivery",
    cartFreeUnlocked: "කොළඹ delivery නොමිලේ!",
    addToCart: "Cart එකට එකතු කරන්න",
    addedToCart: "✓ එකතු කළා",
    /* ---- Before/After ---- */
    before: "පෙර",
    after: "පසු",
    beforeNote: "Bacteria වර්ග 295 · පැය 48 පැවැත්ම",
    afterNote: "99% ආරක්ෂාව · biodegradable",
    /* ---- Hero polish ---- */
    heroBadge: "ශ්‍රී ලංකාවේ අංක 1 සනීපාරක්ෂා Brand",
    heroStat1: "10,000+",
    heroStat1Label: "විකුණූ packs",
    heroStat2: "4.9★",
    heroStat2Label: "ගනුදෙනුකරු ශ්‍රේණිය",
    heroStat3: "99%",
    heroStat3Label: "ආරක්ෂාව",
    whyUsBadge: "ගනුදෙනුකරුවන් අපව තෝරාගන්නේ ඇයි",
    faqTeaserTitle: "ශීඝ්‍ර පිළිතුරු",
    faqTeaserSub: "අපගේ ගනුදෙනුකරුවන් වැඩිපුරම අසන ප්‍රශ්න",
    faqQ1: "මේ ආවරණ ඇත්තටම biodegradable ද?",
    faqA1: "ඔව් — අපගේ ආවරණ ශාක මත පදනම් කොට සාදා ඇති අතර සති කිහිපයක් තුළ ස්වාභාවිකව දිරාපත් වේ. Septic system සඳහාද ආරක්ෂිතයි.",
    faqQ2: "Delivery කොපමණ කාලයක් ගතවේද?",
    faqA2: "කොළඹ ප්‍රදේශය: දින 1–2 සහ delivery නොමිලේ. කොළඹින් පිටත: දින 2–5 සහ delivery LKR 350.",
    faqQ3: "තෘප්තිමත් නැත්නම් ආපසු දිය හැකිද?",
    faqA3: "අනිවාර්යයෙන්. දින 7 තුළ 100% මුදල් ආපසු සහතිකයක් — ප්‍රශ්න නැත.",
    faqQ4: "හෝටල් හෝ කාර්යාල සඳහා bulk වට්ටම් තිබේද?",
    faqA4: "ඔව්. හෝටල්, රෝහල්, කාර්යාල සඳහා විශේෂ ව්‍යාපාරික මිලකරණ ඇත. B2B පිටුව හරහා සම්බන්ධ වන්න.",
    faqQ5: "සංවේදී සමට ආරක්ෂිතද?",
    faqA5: "ඔව් — hypoallergenic, dermatologist පරීක්ෂිත, දරුණු රසායනික නොමැත. ළමයින්, වැඩිහිටියන් සහ ගර්භණී කාන්තාවන්ට ආරක්ෂිතයි.",
    seeItInAction: "ක්‍රියාවේදී බලන්න",
    dragSliderTip: "වෙනස බැලීමට slider එක drag කරන්න",
    asFeaturedIn: "මෙහි දක්වා ඇත",
    quickOrder: "ශීඝ්‍ර ඇණවුම",
  ...
  ta: {
    ...
    freeDeliveryNote: "கொழும்பு பகுதிக்கு மட்டும் · வெளியே LKR 350",
    freeDeliveryUnlocked: "கொழும்பு பகுதிக்கு டெலிவரி இலவசம்",
    addMore: "கொழும்புக்கு வெளியே டெலிவரி LKR 350",
    ...
    deliveryProgressUnlocked: "கொழும்பு பகுதிக்கு டெலிவரி இலவசம்",
    deliveryProgressAdd: "கொழும்புக்கு வெளியே டெலிவரி LKR {0}",
    deliveryProgressFree: "",
    /* ---- Announcement Bar ---- */
    announcement: "🎁 குறுகிய காலம்: 5% தள்ளுபடி + கொழும்பு டெலிவரி இலவசம் · வெளியே LKR 350",
    /* ---- Live Purchase ---- */
    justOrdered: "ஆர்டர் செய்தார்",
    minutesAgo: "நிமிடம் முன்பு",
    /* ---- Newsletter ---- */
    newsletterBadge: "உங்கள் முதல் ஆர்டரில் 5% தள்ளுபடி",
    newsletterTitle: "Hygenc குடும்பத்தில் சேருங்கள்",
    newsletterSub: "சுகாதார குறிப்புகள், புதிய தயாரிப்புகள் மற்றும் சந்தாதாரர்களுக்கான தள்ளுபடிகள் — நேரடியாக உங்கள் inbox இல்.",
    newsletterPlaceholder: "உங்கள் email முகவரி",
    newsletterCta: "என் தள்ளுபடியை பெறு →",
    newsletterPrivacy: "Spam இல்லை. எப்போது வேண்டுமானாலும் unsubscribe செய்யலாம்.",
    newsletterThanks: "சேர்ந்துவிட்டீர்கள்! உங்கள் inbox ஐ சரிபார்க்கவும்.",
    newsletterThanksSub: "உங்கள் தள்ளுபடி code ஐ விரைவில் அனுப்புவோம்.",
    /* ---- Trust Badges ---- */
    trustSecure: "பாதுகாப்பான Checkout",
    trustSecureDesc: "WhatsApp encrypted ஆர்டர்",
    trustDelivery: "தீவு முழுவதும் டெலிவரி",
    trustDeliveryDesc: "வேகமான, நம்பகமான",
    trustGuarantee: "பணம் திரும்ப உத்தரவாதம்",
    trustGuaranteeDesc: "திருப்தியில்லையா? முழு திருப்பி",
    trustReviews: "4.9 / 5 வாடிக்கையாளர் மதிப்பீடு",
    trustReviewsDesc: "124+ மதிப்புரைகள் அடிப்படையில்",
    /* ---- Cart ---- */
    yourCart: "உங்கள் Cart",
    cartEmpty: "உங்கள் cart காலியாக உள்ளது",
    cartEmptySub: "தொடங்க ஒரு தயாரிப்பை சேர்க்கவும்",
    cartSubtotal: "Subtotal",
    cartCheckout: "WhatsApp மூலம் Checkout",
    cartClear: "Cart ஐ காலி செய்",
    cartRemove: "அகற்று",
    cartAddMore: "மேலும் சேர்க்கவும்",
    cartForFreeDelivery: "கொழும்புக்கு வெளியே டெலிவரி",
    cartFreeUnlocked: "கொழும்பு டெலிவரி இலவசம்!",
    addToCart: "Cart இல் சேர்",
    addedToCart: "✓ சேர்க்கப்பட்டது",
    /* ---- Before/After ---- */
    before: "முன்பு",
    after: "பின்பு",
    beforeNote: "295 பாக்டீரியா வகைகள் · 48 மணி நேரம்",
    afterNote: "99% பாதுகாப்பு · biodegradable",
    /* ---- Hero polish ---- */
    heroBadge: "இலங்கையின் #1 சுகாதார பிராண்டு",
    heroStat1: "10,000+",
    heroStat1Label: "விற்பனை packs",
    heroStat2: "4.9★",
    heroStat2Label: "வாடிக்கையாளர் மதிப்பீடு",
    heroStat3: "99%",
    heroStat3Label: "பாதுகாப்பு",
    whyUsBadge: "வாடிக்கையாளர்கள் ஏன் எங்களை தேர்வு செய்கிறார்கள்",
    faqTeaserTitle: "விரைவு பதில்கள்",
    faqTeaserSub: "எங்கள் வாடிக்கையாளர்கள் அதிகம் கேட்கும் கேள்விகள்",
    faqQ1: "இந்த கவர்கள் உண்மையில் biodegradable ஆ?",
    faqA1: "ஆம் — எங்கள் கவர்கள் தாவர அடிப்படையில் தயாரிக்கப்பட்டவை, சில வாரங்களில் இயற்கையாக சிதைகின்றன. Septic systems க்கும் பாதுகாப்பானது.",
    faqQ2: "டெலிவரி எவ்வளவு நேரம் ஆகும்?",
    faqA2: "கொழும்பு பகுதி: 1–2 நாட்கள் மற்றும் டெலிவரி இலவசம். கொழும்புக்கு வெளியே: 2–5 நாட்கள் மற்றும் டெலிவரி LKR 350.",
    faqQ3: "திருப்தியில்லை என்றால் திருப்பித்தர முடியுமா?",
    faqA3: "நிச்சயமாக. டெலிவரி பெற்ற 7 நாட்களுக்குள் 100% பணம் திரும்ப உத்தரவாதம் — கேள்விகள் இல்லை.",
    faqQ4: "ஹோட்டல் அல்லது அலுவலகத்திற்கு bulk தள்ளுபடி உள்ளதா?",
    faqA4: "ஆம். ஹோட்டல்கள், மருத்துவமனைகள், அலுவலகங்களுக்கு சிறப்பு வணிக விலை உள்ளது. B2B பக்கம் மூலம் தொடர்பு கொள்ளுங்கள்.",
    faqQ5: "உணர்திறன் தோலுக்கு பாதுகாப்பானதா?",
    faqA5: "ஆம் — hypoallergenic, dermatologist சோதிக்கப்பட்டது, கடுமையான ரசாயனங்கள் இல்லை. குழந்தைகள், முதியவர்கள், கர்ப்பிணிகளுக்கு பாதுகாப்பானது.",
    seeItInAction: "செயலில் பாருங்கள்",
    dragSliderTip: "வித்தியாசத்தை காண slider ஐ drag செய்யுங்கள்",
    asFeaturedIn: "இடம்பெற்றது",
