...
const perks = [
  {
    icon: "💸",
    title: "No Limit",
    desc: "Refer as many friends as you like. Every successful referral earns you a discount.",
  },
  {
    icon: "⚡",
    title: "Instant Reward",
    desc: "Your discount is applied the moment your referral's order is confirmed.",
  },
  {
    icon: "🌿",
    title: "Spread Hygiene",
    desc: "Help your community stay safe. Every referral means one more person protected.",
  },
  {
    icon: "📱",
    title: "Works on WhatsApp",
    desc: "No app, no signup needed. Just share a message and we handle the rest.",
  },
];
    ...
    <>
      ...
      <section className="py-16 px-5 max-w-4xl mx-auto text-center">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {steps.map(({ icon, title, desc }) => (
            <div
              key={title}
              className="flex flex-col items-center bg-white rounded-2xl shadow-md p-8 hover:-translate-y-1 transition-transform duration-300"
            >
      ...
      <section className="py-10 px-5 bg-[#28a745]">
        <div className="max-w-lg mx-auto text-center text-white">
          ...
          <p className="opacity-90 mb-6 text-sm">
            Enter your name so your friends can mention it when ordering.
          </p>
          {shared ? (
      ...
      <section className="py-16 px-5 max-w-5xl mx-auto">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {perks.map(({ icon, title, desc }) => (
            <div
              key={title}
              className="bg-white rounded-xl shadow-md p-6 text-center hover:-translate-y-1 hover:shadow-xl transition-all duration-300"
            >
      ...
      <section className="max-w-2xl mx-auto px-5 pb-16 text-center">
        <p className="text-gray-400 text-xs leading-relaxed">
          Terms & Conditions: Discount applies to the referred person's first
          order only. Referrer's discount is applied to their next confirmed
          order after the referral order is placed. Cannot be combined with
          other offers. Intimate Hygiene Enterprises reserves the right to
          modify or terminate this programme at any time.
        </p>
      </section>
