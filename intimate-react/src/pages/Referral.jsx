...
export default function Referral() {
  ...
  return (
    <>
      <SEO
        title="Refer & Earn"
        description="Refer friends to Intimate Hygiene and earn rewards on every successful order. Share your link and start earning today."
        path="/referral"
      />
      <Navbar />
      ...
      >
        ...
        <div className="relative z-10 max-w-2xl">
          ...
          <p className="text-lg opacity-90">
            Share with friends and you both get 10% off your next order.
          </p>
        </div>
      </section>
      ...
      <main className="max-w-4xl mx-auto px-5 py-14 space-y-14">
        ...
        <section>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            {perks.map(({ icon: Icon, title, desc }) => (
              <div
                key={title}
                className="flex gap-4 bg-white rounded-2xl shadow-sm p-5 border border-gray-100 hover:shadow-md transition-shadow"
              >
        ...
        <section className="bg-gradient-to-br from-[#28a745] to-[#1d7a34] rounded-2xl p-8 text-white text-center shadow-xl">
          ...
          <h2 className="text-2xl font-bold mb-2">
            Generate Your Referral Message
          </h2>
          <p className="text-white/80 mb-6 text-sm">
            Enter your name and we'll craft the perfect WhatsApp message for
            you.
          </p>
          ...
          {shared ? (
            <div className="bg-white/15 rounded-xl p-5 max-w-sm mx-auto">
              ...
              <p className="text-white/75 text-sm mt-1">
                Tell your friends to mention your name when ordering.
              </p>
              <button
