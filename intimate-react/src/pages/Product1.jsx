...
export default function Product1() {
  return (
    <>
      <SEO
        title="Single Use Pack – LKR 250"
        description="Biodegradable single use toilet seat covers. Individually wrapped, eco-friendly, hygienic. Minimum order 10 packs. Buy online in Sri Lanka."
        path="/products/1"
      />
      <ProductDetailLayout
