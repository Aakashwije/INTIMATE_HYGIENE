    ...
    <>
      ...
      >
        ...
        <div className="relative z-10 max-w-3xl">
          <h1 className="text-4xl md:text-5xl font-bold mb-5 drop-shadow-md">Hygiene Insights</h1>
          <p className="text-lg md:text-xl leading-relaxed opacity-95">
            Science-backed articles on hygiene, travel health, and why protection matters every day.
          </p>
        </div>
      </section>
      ...
      <section className="bg-[#28a745] text-white text-center py-16 px-5">
        ...
        <p className="text-lg mb-6 opacity-95">
          Start with our eco-friendly disposable toilet seat covers — available in single, travel, and enterprise packs.
        </p>
        <a
          href="/products"
