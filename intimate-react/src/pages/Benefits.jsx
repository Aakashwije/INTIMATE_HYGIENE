...
const benefitDefs = [
  {
    icon: faBacteria,
    titleKey: "maxHygieneBenefit",
    descKey: "maxHygieneBenefitDesc",
  },
  {
    icon: faLeaf,
    titleKey: "ecoFriendlyBenefit",
    descKey: "ecoFriendlyBenefitDesc",
  },
  { icon: faDroplet, titleKey: "waterSaving", descKey: "waterSavingDesc" },
  {
    icon: faPersonBreastfeeding,
    titleKey: "laborSaving",
    descKey: "laborSavingDesc",
  },
  { icon: faBoxOpen, titleKey: "portable", descKey: "portableDesc" },
  { icon: faUsers, titleKey: "familyFriendly", descKey: "familyFriendlyDesc" },
  {
    icon: faHospital,
    titleKey: "expertRecommended",
    descKey: "expertRecommendedDesc",
  },
  {
    icon: faShower,
    titleKey: "antiSplash",
...
const benefitFallbacks = {
  ...
  antiSplashDesc:
    "The central fold of the seat cover prevents water from touching the user's skin.",
  preventsContam: "Prevents Cross-Contamination",
  preventscontamDesc:
    "Minimizes exposure to bacteria and viruses that can spread in shared restroom environments.",
  skinSafe: "Safe for Skin",
  skinSafeDesc:
    "Made from gentle, skin-safe materials that prevent irritation, allergies, or rashes.",
  ecoPackaging: "Eco-Conscious Packaging",
  ecoPackagingDesc:
    "Our packaging is designed to be recyclable and environmentally friendly.",
  travelFriendly: "Travel-Friendly",
  travelFriendlyDesc:
    "Lightweight packs fit easily in luggage, handbags, or backpacks.",
  quickSetup: "Quick Setup",
  quickSetupDesc: "No complicated installation required. Simply place and use.",
  reducesWaste: "Reduces Waste",
  reducesWasteDesc:
    "Prevents excessive use of paper towels, wipes, and chemical cleaners.",
  extraClean: "Extra Cleanliness",
  extraCleanDesc:
    "Provides an additional hygiene layer even on sanitized toilets.",
};
...
export default function Benefits() {
  ...
  return (
    <>
      <SEO
        title="Health & Hygiene Benefits"
        description="Discover the health benefits of using disposable toilet seat covers in public restrooms. Protect yourself from bacteria and infections with Intimate Hygiene."
        path="/benefits"
      />
      <Navbar />
          ...
          {benefitDefs.map(({ icon, titleKey, descKey }) => (
            ...
            >
              ...
              <p className="text-gray-600 text-sm leading-relaxed">
                {t[descKey] || benefitFallbacks[descKey]}
              </p>
            </div>
          ))}
        </div>
