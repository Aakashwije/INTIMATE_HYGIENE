  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await createInquiry({
        ...
        volume: form.volume,
        message: form.message || "No additional requirements.",
        status: "new",
      });
      setFormStatus("Saved. Opening WhatsApp now...");
    } catch (err) {
      setFormStatus(err.message || "Could not save inquiry. Opening WhatsApp.");
    }
  ...
  return (
    <>
      <SEO
        ...
        description="Wholesale toilet seat covers for hotels, hospitals, offices and restaurants in Sri Lanka. Custom branding, free dispensers and volume discounts available."
        path="/b2b"
      />
      <Navbar />
      ...
      <section id="b2b-form" className="py-16 px-5 max-w-2xl mx-auto">
        ...
        <form
          ...
          className="bg-white rounded-2xl shadow-md p-5 sm:p-8 space-y-4"
        >
          ...
          >
            ...
            {submitting ? "Saving..." : "Send Enquiry via WhatsApp"}
          </button>
          {formStatus && (
