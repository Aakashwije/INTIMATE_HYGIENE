    ...
    <>
      ...
      >
        ...
        <div className="relative z-10 max-w-3xl">
          ...
          <h1 className="text-4xl md:text-5xl font-bold mb-5 drop-shadow-md">B2B Solutions</h1>
          <p className="text-lg md:text-xl leading-relaxed opacity-95">
            Volume pricing, custom branding, and dedicated support for hotels, hospitals, offices & more.
          </p>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {tiers.map(({ name, volume, price, unit, color, badge, highlight, features }) => (
              ...
              >
                ...
                <span className={`text-xs font-semibold px-3 py-1 rounded-full self-start mb-3 ${badge}`}>
                  {name}
                </span>
      ...
      <section className="py-10 px-5 bg-gray-50">
        <div className="max-w-md mx-auto text-center">
          <h3 className="text-xl font-bold text-gray-800 mb-2">📱 Quick Reorder Anytime</h3>
