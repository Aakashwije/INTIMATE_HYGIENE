...
export default function Product2() {
  return (
    <>
      <SEO
        title="Travel Pack (Waterproof) – LKR 350"
        description="Waterproof anti-slip disposable toilet seat covers. Perfect for travellers. 10-pack, minimum order 5 packs. Ships islandwide in Sri Lanka."
        path="/products/2"
      />
      <ProductDetailLayout
