...
export default function DiscountPopup() {
  ...
  const handleRedeem = () => {
    ...
    window.open(
      `https://wa.me/94729991950?text=${encodeURIComponent(msg)}`,
      "_blank",
    );
    setShow(false);
  };
    ...
    <div className="fixed inset-0 z-[200] flex items-center justify-center px-4">
      ...
      <div className="relative bg-white rounded-2xl shadow-2xl max-w-sm w-full p-8 text-center animate-slideUp">
        ...
        <h2 className="text-2xl font-bold text-gray-800 mb-1">
          Welcome! Here's 5% Off
        </h2>
        <p className="text-gray-500 text-sm mb-5">
          Use this code on your first order and get 5% off. Just mention it when
        ...
        <p className="text-xs text-gray-400 mt-4">
          Valid on first order only. Cannot be combined with B2B pricing.
        </p>
      </div>
    </div>
  );
