...
const badges = [
  { icon: Lock,        titleKey: "trustSecure",   descKey: "trustSecureDesc" },
  { icon: Truck,       titleKey: "trustDelivery",  descKey: "trustDeliveryDesc" },
  { icon: ShieldCheck, titleKey: "trustGuarantee", descKey: "trustGuaranteeDesc" },
  { icon: Star,        titleKey: "trustReviews",   descKey: "trustReviewsDesc" },
];
