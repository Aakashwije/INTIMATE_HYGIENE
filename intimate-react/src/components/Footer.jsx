  ...
  return (
    <footer className="bg-[#222] text-white pt-16 pb-5 px-5 mt-12">
      <div className="flex flex-wrap justify-between max-w-6xl mx-auto gap-8">
        ...
        <div className="flex-1 min-w-[200px]">
          ...
          <p className="text-sm text-gray-300 leading-relaxed">
            Intimate Hygiene Enterprises provides premium hygienic toilet seat
            covers, designed for comfort, safety, and eco-friendliness. Protect
            yourself and the environment wherever you go.
          </p>
        </div>
          ...
          <ul className="list-none space-y-2 text-sm">
            {[
              ...
              <li key={to}>
                <Link
                  to={to}
                  className="text-white hover:text-[#81a42f] transition-colors"
                >
                  {label}
                </Link>
              </li>
          ...
          <div className="space-y-2 text-sm text-gray-300">
            <p>
              ...
              <a
                ...
                className="text-white hover:text-[#81a42f]"
              >
        ...
        <div className="flex-1 min-w-[150px]">
          ...
          <div className="flex flex-col gap-3 text-sm">
            <a
              ...
              className="text-white hover:text-[#81a42f] flex items-center gap-2"
            >
      ...
      <div className="border-t border-gray-600 mt-8 pt-4 flex flex-col items-center text-center text-sm text-gray-400 gap-1">
        <p>&copy; 2025 Intimate Hygiene. All Rights Reserved.</p>
        <div>
