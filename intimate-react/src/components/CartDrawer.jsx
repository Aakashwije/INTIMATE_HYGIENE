          ...
          {items.length === 0 ? (
            ...
            <ul className="space-y-3">
              {items.map((i) => (
                ...
                >
                  <img src={i.img} alt={i.name} className="w-16 h-16 rounded-lg object-cover flex-shrink-0" />
                  <div className="flex-1 min-w-0">
                    ...
                    <div className="flex items-center gap-2">
                      <button
                        ...
                        className="w-7 h-7 rounded-md bg-white border border-gray-200 text-gray-600 font-bold hover:border-[#28a745] hover:text-[#28a745]"
                      >
                        −
                      </button>
