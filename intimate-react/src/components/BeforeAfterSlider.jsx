...
export default function BeforeAfterSlider() {
  ...
  return (
    ...
    >
      ...
      >
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-12 h-12 rounded-full bg-white shadow-2xl flex items-center justify-center text-[#28a745] font-bold text-lg">
          ⇆
        </div>
      </div>
